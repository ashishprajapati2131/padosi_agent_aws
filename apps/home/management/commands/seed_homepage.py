...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        quick_picks = [
            ...
            {'label': 'Term Plan', 'badge_text': 'Pure Cover', 'badge_bg_color': '#e0f2fe', 'badge_text_color': '#0369a1', 'icon_bg_color': '#f0f9ff', 'icon_color': '#0284c7', 'icon': 'shield', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Life%20Insurance&InsuranceCompany=Term%20Plan&openFilter=1', 'order': 2},
            ...
            {'label': 'Two Wheeler', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#ecfdf5', 'icon_color': '#059669', 'icon': 'scooter', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Motor%20Insurance&InsuranceCompany=Two%20Wheeler&openFilter=1', 'order': 4},
            {'label': 'Critical Illness', 'badge_text': 'Lumpsum', 'badge_bg_color': '#fae8ff', 'badge_text_color': '#a21caf', 'icon_bg_color': '#fdf4ff', 'icon_color': '#c026d3', 'icon': 'stethoscope', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Health%20Insurance&InsuranceCompany=Critical%20Illness&openFilter=1', 'order': 5},
            {'label': 'Personal Accident', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#fff7ed', 'icon_color': '#ea580c', 'icon': 'activity', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Health%20Insurance&InsuranceCompany=Personal%20Accident&openFilter=1', 'order': 6},
            {'label': 'Super Top-up', 'badge_text': 'Save Big', 'badge_bg_color': '#ccfbf1', 'badge_text_color': '#0f766e', 'icon_bg_color': '#f0fdfa', 'icon_color': '#0d9488', 'icon': 'arrow-up-circle', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Health%20Insurance&InsuranceCompany=Super%20Top-up&openFilter=1', 'order': 7},
            {'label': 'ULIP Plan', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#f5f3ff', 'icon_color': '#7c3aed', 'icon': 'trending-up', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Life%20Insurance&InsuranceCompany=ULIP%20Plan&openFilter=1', 'order': 8},
            {'label': 'Pension Plan', 'badge_text': 'Lifetime', 'badge_bg_color': '#e0e7ff', 'badge_text_color': '#4338ca', 'icon_bg_color': '#eef2ff', 'icon_color': '#4f46e5', 'icon': 'clock', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=Life%20Insurance&InsuranceCompany=Pension%20Plan&openFilter=1', 'order': 9},
            ...
            {'label': 'Fire (SME)', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#fef2f2', 'icon_color': '#dc2626', 'icon': 'store', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=SME%20Insurance&InsuranceCompany=Others&openFilter=1', 'order': 12},
            {'label': 'Cyber (SME)', 'badge_text': 'New', 'badge_bg_color': '#cffafe', 'badge_text_color': '#0e7490', 'icon_bg_color': '#ecfeff', 'icon_color': '#0891b2', 'icon': 'monitor', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=SME%20Insurance&InsuranceCompany=Cyber%20(SME)&openFilter=1', 'order': 13},
            {'label': 'Liability (SME)', 'badge_text': '', 'badge_bg_color': '', 'badge_text_color': '', 'icon_bg_color': '#f1f5f9', 'icon_color': '#475569', 'icon': 'briefcase', 'url': '/find-agents?ServiceType=New%20Policy&InsuranceType=SME%20Insurance&InsuranceCompany=Liability%20(SME)&openFilter=1', 'order': 14},
        ]
