...
def generate_professional_bio(request):
    ...
    try:
        ...
        fullname     = request.POST.get("full_name") or agent.fullname or ""
        agency_name  = request.POST.get("agency_name") or profile.agency_name or ""
        experience   = request.POST.get("experience_years") or str(profile.experience_years or getattr(agent, "experience_range", "") or "")
        
        city_post = request.POST.get("serviceable_cities[]") or request.POST.get("serviceable_cities")
        ...
        languages    = request.POST.get("languages") or profile.formatted_languages or ""
        highlights   = profile.career_highlights or ""
        pincode      = request.POST.get("service_pincode") or agent.get_effective_pincode() or ""
        
        investments_post = request.POST.getlist("investment_types[]") or request.POST.getlist("investment_types")
        if investments_post:
        ...
        is_licensed  = bool(request.POST.get("license_number") or profile.license_number or profile.arn_number)

        client_base_post = request.POST.get("client_base")
        ...
        success_rate_post = request.POST.get("success_rate")
        ...
        segments_post = request.POST.getlist("segments[]") or request.POST.getlist("segments")
        if segments_post:
